...
const icon = {
dislike: <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="25" cy="25" r="25" fill="#ECECEC"/>
<path d="M37.2795 15.8615C34.8786 13.3572 31.4274 12.4181 28.1262 13.3572L24.0747 23.2178L28.2763 24.3135C29.0265 24.47 29.6267 25.4091 29.3266 26.1917C29.3266 26.3482 29.3266 26.3482 29.1766 26.5047L26.1755 32.7654C26.0254 33.3915 25.5753 33.7045 24.9751 33.7045C24.675 33.7045 24.5249 33.7045 24.3749 33.548C23.6246 33.235 23.3245 32.2959 23.6246 31.5133L25.7253 26.9743L21.6739 25.8787C20.7736 25.5656 20.3234 24.783 20.4735 24.0004C20.4735 23.8439 20.4735 23.8439 20.4735 23.8439L24.2248 14.7659C20.0233 11.6355 14.1712 13.0442 11.4702 17.5832C9.06936 21.4961 9.66957 26.5047 12.8207 29.7916L24.0747 41.5304C24.675 42.1565 25.5753 42.1565 26.1755 41.5304L37.4295 29.7916C40.8808 25.8787 40.8808 19.7745 37.2795 15.8615Z" fill="#BA6FF6"/>
</svg>,
like: <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="25" cy="25" r="25" fill="#ECECEC"/>
<path d="M36.6207 16.5052C33.2167 13.0338 29.2749 14.4979 26.8342 16.0461C25.455 16.921 23.5446 16.921 22.1655 16.0461C19.7247 14.4979 15.783 13.0338 12.3789 16.5052C4.29829 24.7457 18.1559 40.625 24.4999 40.625C30.8438 40.625 44.7014 24.7457 36.6207 16.5052Z" fill="#8E00FE" fill-opacity="0.53"/>
</svg>,
comment: <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="25" cy="25" r="25" fill="#ECECEC"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M37.9727 29.9012C40.7972 24.4911 38.1083 18.0737 35.0175 14.9828C29.4851 9.45039 20.5152 9.45039 14.9828 14.9828C9.45039 20.5152 9.45039 29.4851 14.9828 35.0175C18.2051 38.2398 24.5128 40.8192 29.9032 37.976C30.4571 37.6838 30.7343 37.5376 30.8697 37.4831C31.4417 37.2531 31.7426 37.218 32.3521 37.3105C32.4964 37.3325 32.6853 37.3814 33.0629 37.4793C34.1958 37.7729 34.7625 37.9198 35.1754 37.9049C36.6602 37.8514 37.8514 36.6602 37.9049 35.1754C37.9198 34.7625 37.773 34.196 37.4793 33.0631C37.3815 32.6855 37.3325 32.4966 37.3106 32.3531C37.2178 31.7436 37.2512 31.4514 37.4791 30.8786C37.5328 30.7437 37.6794 30.4629 37.9727 29.9012ZM20.5489 24.7989C20.5489 25.5813 19.9146 26.2155 19.1322 26.2155C18.3498 26.2155 17.7155 25.5813 17.7155 24.7989C17.7155 24.0165 18.3498 23.3822 19.1322 23.3822C19.9146 23.3822 20.5489 24.0165 20.5489 24.7989ZM26.2155 24.7989C26.2155 25.5813 25.5813 26.2155 24.7989 26.2155C24.0165 26.2155 23.3822 25.5813 23.3822 24.7989C23.3822 24.0165 24.0165 23.3822 24.7989 23.3822C25.5813 23.3822 26.2155 24.0165 26.2155 24.7989ZM30.4655 26.2155C31.2479 26.2155 31.8822 25.5813 31.8822 24.7989C31.8822 24.0165 31.2479 23.3822 30.4655 23.3822C29.6831 23.3822 29.0489 24.0165 29.0489 24.7989C29.0489 25.5813 29.6831 26.2155 30.4655 26.2155Z" fill="#8E00FE" fill-opacity="0.53"/>
</svg>,
share: <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="25" cy="25" r="25" fill="#ECECEC"/>
<g clip-path="url(#clip0_2259_7470)">
<path d="M27.875 27.7024C21.5583 27.7024 16.1889 30.9515 14.125 35.5V34.1154C14.125 25.8434 20.2039 19.0963 27.875 18.5903V12.125L38.875 23.125L27.875 34.125V27.7079" fill="#8E00FE" fill-opacity="0.53"/>
<path d="M27.875 27.7024C21.5583 27.7024 16.1889 30.9515 14.125 35.5V34.1154C14.125 25.8434 20.2039 19.0963 27.875 18.5903V12.125L38.875 23.125L27.875 34.125V27.7079" stroke="#8E00FE" stroke-opacity="0.53" stroke-width="2.0625" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
...
lukplayer2 ? lukplayer2.forEach(el => el.style.backgroundColor = "transparent") : ''
...
lukplayer3 ? lukplayer3.forEach(el => el.style.background = `url(${placeImage})`) : ''
      ...
      return(
        ...
        <div className={style.user_wrapper}>
          ...
          <figure>
              <Image src={`${env.cloudfront}${User?.profile?.avatar}`} alt="" width="150" height="150" />
            </figure>
      ...
      {`${description.slice(0, 105)}... `} <Link href="/">Load More</Link> 
      </div>
            </div>
