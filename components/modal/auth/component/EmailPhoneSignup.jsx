    ...
    <div className={style.email_phone_auth_wrapper}>
      <div className={style.auth_option_tab}>
        <div
          ...
          className={`${style.option} ${tab === 'phone' ? style.active : ''}`}
        >
          Phone Number
        </div>
        <div
          onClick={() => setTab('email')}
          className={`${style.option} ${tab === 'email' ? style.active : ''}`}
        >
          Email
        </div>
      </div>
      <div className={style.auth_tab_body_wrapper}>
        ...
        <div className={style.input_contain}>
          <label htmlFor="email">What&apos;s your birthday?</label>
          <span>
            <input
              type="date"
              name="dob"
       ...
       */}
        ...
        <div className={style.password_input_contain}>
          ...
          <span>
            <figure onClick={() => setVisible(!visible)}>
              {visible ? authIcons.eye_opened : authIcons.eye_closed}
            </figure>
            <input
              name="password"
              onChange={handleFieldChange}
        ...
        <div className={style.forgot_wrapper}>
          ...
          <div className={style.forgot_pwd}>Forgot Password</div>
        </div>
